...
@dataclass
class NeuSAccCustomModelConfig(NeuSModelConfig):
    """UniSurf Model Config"""

    _target: Type = field(default_factory=lambda: NeuSAccCustomModel)
    sky_loss_mult: float = 0.01
    """Sky segmentation normal consistency loss multiplier."""


class NeuSAccCustomModel(NeuSModel):
    """VolSDF model
    ...
    config: NeuSAccCustomModelConfig
